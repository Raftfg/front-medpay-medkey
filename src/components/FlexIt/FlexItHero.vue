    ...
    <div class="slider swiper-container">
      <div class="swiper-wrapper">
        <div v-for="(slide, index) in slides" :key="index" class="swiper-slide">
          <div class="slide-bg-img" :style="{ backgroundImage: 'url(' + bgImages[index] + ')' }">
...
export default {
  ...
  data() {
    return {
      bgImages: [
        require("@/assets/flex-it/assets/images/hero/hero-bg-2.jpg"),
        require("@/assets/flex-it/assets/images/hero/hero-bg-1.jpg"),
        require("@/assets/flex-it/assets/images/hero/hero-bg-3.jpg")
      ]
    };
  },
  computed: {
    slides() {
      return this.$t('accueil.hero.slides');
    }
  }
};
</script>
