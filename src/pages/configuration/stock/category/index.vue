<template>
  <section class="tables">
    ...
    <div class="modal fade" id="addCategoryModal" ref="addCategoryModal">
            ...
            <form class="forms-sample row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="invalid-feedback" v-if="formErrors.name.haveError">
                    {{ formErrors.name.message }}
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    preparingForCategoryUpdate(uuid){
      categoryService.getCategory(uuid).then((res) => {
    ...
    supprimer(index) {
      ...
      this.deleteName = this.categories[index].name;
    ...
    confirmDelete() {
      ...
      if (index !== null) {
        categoryService
        .deleteCategory(this.categories[index].uuid)
        .then((res) => {
