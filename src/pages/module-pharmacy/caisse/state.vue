      ...
      <div class="col-lg-12 grid-margin tables">
        <div class="card">
          <div class="card-body">
            ...
            <h4 class=" text-white rounded p-3 text-center mb-3"
              ...
              <span v-else>Etat de caisse</span>
            </h4>
            ...
            <div class="table-responsive " v-if="caisses.length > 0">
              ...
              <table class="table table-bordered" width="100%" cellspacing="0">
                <thead>
                  <tr style="background-color: rgb(216, 218, 216)">
                    ...
                    <th style="width: 5%; text-align:right">Statut</th>
    ...
    loadMyTable() {
      ...
      caisseService
        ...
        .then((res) => {
          ...
          this.caisses = res.data.data.filter(caisse => caisse.id === cashRegisterId);
    ...
    confirmOpenCashier() {
      ...
      if (this.caisseToOpen) {
        const requestBody = {
          ...
          total_partial: this.caisseToOpen.total_partial,
          totalMtnMomo: this.caisseToOpen.totalMtnMomo,
          totalMoovMomo: this.caisseToOpen.totalMoovMomo,
          totalCeltis: this.caisseToOpen.totalCeltis,
          totalCarteBancaire: this.caisseToOpen.totalCarteBancaire,
          totalCarteCredit: this.caisseToOpen.totalCarteCredit,
          totalTresorPay: this.caisseToOpen.totalTresorPay,
          statut: 0, // Statut (0 pour ouvert, 1 pour fermé)
        };

        console.log("this.caisseToOpen")
        console.log(this.caisseToOpen)
