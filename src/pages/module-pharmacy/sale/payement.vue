      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <h4 class=" text-white rounded p-3 mb-5 text-center"
            ...
            <div class="row col-md-12 mt-n4">
              ...
              <div class="col-md-4" v-if="cashsHistoricalCurrent && cashsHistoricalCurrent.created_at">
                <h5>
              ...
              <div class="col-md-4" v-if="cashsHistoricalCurrent && cashsHistoricalCurrent.statut == 1">
                <h5>
              ...
              <div class="col-md-4" v-if="cashsHistoricalCurrent && cashsHistoricalCurrent.statut == 0">
                <h5>
            ...
            <div v-if="filteredMedicalActDetailsA.length > 0 &&
              ...
              <ul class="nav nav-tabs d-flex justify-content-between" role="tablist">
                <li>
                  <button class="nav-link active font-weight-bold custom-tab" data-bs-toggle="tab" href="#tab1">
                    Détails du paiement des prestations
                  </button>
                </li>
                <li class="d-flex">
                  <select class="form-control mb-0" style="width: 300px; background-color: #e0faf3"
                    ...
                    <option value="" style="margin-top: 10px;" disabled>MODES DE PAIEMENT</option>
                      ...
                      <tbody>
                        <tr v-for="(item, index) in filteredMedicalActDetailsA" :key="index">
                          ...
                          <td style="text-align: right !important">
                            {{ formatNumber(parseInt(item.prix)) }}
                          </td>
                          <td style="text-align: right !important">
                            {{ formatNumber(item.quantite * item.prix) }}
                          </td>
                        </tr>
                        ...
                        <tr style="background-color: #d6dbd6 !important">
                          ...
                          <td style="font-weight: bold !important; text-align: right">
                            {{ formatNumber(totalAmountActesA() - montantPrisenchargePourcentageA) }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <div class="d-flex justify-content-between flex-row">
                <div class="mt-0 " v-if="selectedOptionMode >= 1 && selectedOptionMode <= 7">
                  <label for="montantPartiel">
                    <input type="checkbox" class="checkbox" id="isChecked" v-model="isChecked"
                      @change="handleCheckboxChange" />
                    Paiement partiel <span style="color:red"> * </span>
                    <input v-if="isChecked" type="text" @input="validateNumericInput" min="1" max="999999"
                      pattern="[0-9]*" width="100%" id="montantPartiel" class="form-group" placeholder="Montant à payer"
                      v-model="montantPartiel" />

                  </label>
                  <p v-if="showMontantError" class="error-message mt-n3 mx-auto">Ce champ est obligatoire.</p>
                </div>



                <div v-if="selectedOptionMode == 1" class="mt-n1">
                  <div class="justify-content-end text-right">
                    <button @click="validerPayement" type="button"
                      class="btn-medpay-green btn btn-success btn-sm text-center"
                      style="white-space: nowrap; overflow: hidden; flex-shrink: 1">
                      <span class="text-center ml-1" style="font-size: 90%">Payer</span>
                    </button>
                  </div>
                </div>

                <div v-if="selectedOptionMode == 2" class="mt-n1">
                ...
                <div v-if="selectedOptionMode == 3" class="mt-n1">
                ...
                <div v-if="selectedOptionMode == 4" class="mt-n1">
                  <div class="d-flex justify-content-end">
                    <button @click="validerPayement" type="button"
                      class="btn-medpay-green btn btn-success btn-sm text-center mt-n1"
                      style="white-space: nowrap; overflow: hidden">
                ...
                <div v-if="selectedOptionMode == 5" class="mt-n1">
                  <div class="d-flex justify-content-end">
                    <button @click="validerPayement" type="button"
                      class="btn-medpay-green btn btn-success btn-sm text-center mt-n1"
                      style="white-space: nowrap; overflow: hidden">
                ...
                <div v-if="selectedOptionMode == 6" class="mt-n1">
                  <div class="d-flex justify-content-end">
                    <button @click="validerPayement" type="button"
                      class="btn-medpay-green btn btn-success btn-sm text-center mt-n1"
                      style="white-space: nowrap; overflow: hidden">
                ...
                <div v-if="selectedOptionMode == 7" class="mt-n1">
                  <div class="d-flex justify-content-end">
                    <button @click="validerPayement" type="button"
                      class="btn-medpay-green btn btn-success btn-sm text-center mt-n1"
                      style="white-space: nowrap; overflow: hidden">
              ...
              <div v-if="selectedOptionMode == 8" class="mt-n1 text-right">

                <div class="text-right mt-0">
                  <button @click="validerPayement" type="button" class="btn-medpay-green btn btn-success btn-sm mt-n1"
                    style="white-space: nowrap; overflow: hidden">
            ...
            <div v-if="filteredMedicalActDetailsP.length > 0 &&
              this.selectedRow != -1 &&
              this.cashRegisterCashierCurrent.type == 'P'
              ">
              <ul class="nav nav-tabs d-flex justify-content-between" role="tablist">
                <li>
                  <button class="nav-link active font-weight-bold custom-tab" data-bs-toggle="tab" href="#tab1">
                    Détails du paiement des produits
                  </button>
                </li>
                <li class="d-flex">
                  <select class="form-control mb-0" style="width: 300px; background-color: #e0faf3"
                    id="exampleFormControlSelect1" v-model="selectedOptionMode">
                    <option value="" style="margin-top: 10px" disabled>MODES DE PAIEMENT</option>
                ...
                <div class="table-responsive tab-pane fade show active" id="tab1">
                  ...
                  <div>
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr v-for="(item, index) in filteredMedicalActDetailsP" :key="index">
                          <td>{{ index + 1 }}</td>
                          <td style="text-align: left !important">{{ item.code }}</td>
                          <td style="text-align: left !important">
                            {{ item.designation }}
                          ...
                          <td style="text-align: right !important">
                            {{ formatNumberDecimal(item.quantite * item.prix) }}
                          </td>
                        </tr>
                        ...
                        <tr style="background-color: #d6dbd6 !important">
                          ...
                          <td style="font-weight: bold !important; text-align: right">
                            {{ formatNumberDecimal(totalAmountActesP()) }}
                          </td>
                        </tr>
                        <tr>
                          <td colspan="5" style="font-weight: bold !important">
                          ...
                          <td style="font-weight: bold !important; text-align: right">
                            {{ formatNumberDecimal(montantPrisenchargePourcentageP) }} FCFA
                        ...
                        <tr style="background-color: #d6dbd6 !important">
                          ...
                          <td style="font-weight: bold !important; text-align: right">
                            {{ formatNumberDecimal(totalAmountActesP() - montantPrisenchargePourcentageP) }} FCFA
...
export default {
  ...
  data() {
    return {
      ...
      montantPrisenchargePourcentageP: 0.00,
  ...
  methods: {
    ...
    validateNumericInput() {
      ...
      // this.montantPartiel = this.montantPartiel.replace(/\D/g, "");
      this.montantPartiel = this.montantPartiel.replace(/\D/g, "");

          // Si la valeur dépasse 999999, réglez-la sur 999999
          if (parseInt(this.montantPartiel, 10) > 999999999) {
            this.montantPartiel = "999999999";
          }
    ...
    selectRow(index, movmentId) {
      ...
      if (this.selectedRow == index) {
       ...
       this.medicalActDetailsFacture.filter((item) => item.type == "A").length = 0;
      ...
      return; // Arrêtez l'exécution de la méthode si la liste est vide
    }
        ...
        factureService
          ...
          .then((response) => {
            ...
            this.medicalActDetailsFactureP = this.medicalActDetailsFacture.filter(
              (item) => item.type == "P"
            );


            if( this.medicalActDetailsFactureA && this.medicalActDetailsFactureA.length > 0 ){
              
              this.prisenchargePourcentageA =  this.medicalActDetailsFactureA[0].percentage_patient_insurance;
              this.montantPrisenchargePourcentageA = (this.prisenchargePourcentageA * this.totalAmountActesA()) / 100;
              console.log("this.montantPrisenchargePourcentageA ")
              console.log(this.montantPrisenchargePourcentageA )

            }

            if( this.medicalActDetailsFactureP && this.medicalActDetailsFactureP.length > 0 ){
              
              this.prisenchargePourcentageP =  this.medicalActDetailsFactureP[0].percentage_patient_insurance;
              this.montantPrisenchargePourcentageP = (this.prisenchargePourcentageP * this.totalAmountActesP()) / 100;
            ...
            if (
              this.selectedRow != -1 &&
              this.cashRegisterCashierCurrent.type == "P" &&
              this.medicalActDetailsFacture.filter((item) => item.type == "P").length == 0
            ) {
    ...
    kkiapay() {
      ...
      const amountToUse = this.montantPartiel
    ? parseFloat(this.montantPartiel)
    : this.cashRegisterCashierCurrent.type === 'A'
    ...
    successHandler(response) {
      // dans le cas d'une opération reussi cette fonction s'execute
      if (response.transactionId) {
        const transaction_id = response.transactionId;
        console.log(transaction_id);
        payementService
    ...
    ? parseFloat(this.montantPartiel)
    : this.cashRegisterCashierCurrent.type == 'A'
    ? this.totalAmountActesA()
    : this.totalAmountActesP();

      console.log("my tresopay function");
  ...
  return formattedValue;
    ...
    validerPayement() {
      ...
      const totalAmountActes = this.cashRegisterCashierCurrent.type == 'A'
      ? this.totalAmountActesA()
      : this.totalAmountActesP();

    // Vérifiez si le montant saisi est supérieur ou égal au montant total

    if (this.isChecked && !this.montantPartiel) {
        this.showMontantError = true;
        return; // Arrêter l'exécution de la fonction
      }
    
    if (this.isChecked && parseFloat(this.montantPartiel) >= totalAmountActes) {
      // Le montant saisi est supérieur ou égal au montant total, affichez un message d'erreur
      this.showMontantError = false;
      this.$toast.error("Le montant saisie doit être inférieur au montant total à payer sur la facture.", {
        position: "top-right",
        timeout: 3000,
        style: {
          background: "#ff0000",
    ...
    this.showMontantError = false;
      ...
      if (this.cashRegisterCashierCurrent.statut == 1) {
        ...
        // if (this.checkMontant && !this.montantPartiel) {
        //   this.isValid = true;
        //   return;
        // }
    ...
    handleCheckboxChange() {
      // Mise à jour de isValid en fonction de l'état de la case à cocher et du montant
          if (!this.isChecked) {
          this.montantPartiel = ''; // Réinitialiser le champ montantPartiel si la case est décochée
          this.showMontantError = false; // Réinitialiser le message d'erreur
    ...
    payementFacture() {
      ...
      console.log("this.selectedOptionMode")
      console.log(this.selectedOptionMode)
      const referenceToUse = this.cashRegisterCashierCurrent.type == 'A'
    ? this.referenceFactureA
    : this.referenceFactureP;

      const partial_amount = this.isChecked ? this.montantPartiel : 0.00;
      ...
      factureService
        .payementFacture(this.cashRegisterCashierCurrent.id, referenceToUse,  this.selectedOptionMode,  partial_amount) // Utilisez la clé "factures"
        .then((res) => {
          ...
          this.$toast.success("Payement effectué avec succès !", {
  ...
  computed: {
    ...
    filteredMedicalActDetailsA() {
      ...
      const filteredResults = this.medicalActDetailsFacture.filter(
        (item) => item.type == "A"
      );

      // Supposons que vous souhaitez obtenir la référence du premier élément filtré
      if (filteredResults.length > 0) {
        this.referenceFactureA = filteredResults[0].reference;
        console.log(this.referenceFactureA);
      } else {
        this.referenceFactureA = null;
      }
    ...
    filteredMedicalActDetailsP() {
      ...
      // Supposons que vous souhaitez obtenir la référence du premier élément filtré
      if (filteredResults.length > 0) {
        this.referenceFactureP = filteredResults[0].reference;
        console.log(this.referenceFactureP);
      } else {
        this.referenceFactureP = null;
      }
      return filteredResults;
    },
