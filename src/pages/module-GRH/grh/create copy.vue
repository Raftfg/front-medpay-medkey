              ...
              <tab-content title="" icon="">
                <fieldset class="scheduler-border col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Nom du père </label>
                        <input 
                          type="text" class="form-control" id="exampleInputPassword1" placeholder=""
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Nom de la mère </label>
                        <input 
                          type="text" class="form-control" id="exampleInputPassword1" placeholder=""
...
export default {
  ...
  methods: {
    ...
    // Controle avant de passer à la pge suivante
    beforeChange(toIndex, fromIndex) {
      ...
      // onDepartmentSelect(departementId) {
      //   serviceService
      //     .get(departementId)
      //     .then((res) => {
    ...
    onComplete(){
this.store();
// console.log(this.employer.assurances_id);
    }
,
    store() {
      let isValid = true;
