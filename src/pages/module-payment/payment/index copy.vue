  ...
  methods: {
    ...
    generateAndOpenPDF(facture) {
      ...
      const partieVersanteText = [
        ...
        "IPP : " + facture.reference,
        "IEP : " + facture.reference,
        facture.reference + ( facture.reference ? " / " +  facture.reference : ''),
      ...
      if (data && data.length > 0) {
        ...
        for (var i = 0; i < data.length; i++) {
          var row = [
            this.facturesReference.code,
            this.facturesReference.designation,
            this.facturesReference.quantite,
            this.facturesReference.prix,
            this.facturesReference.amount,
          ];

          total += parseInt( this.facturesReference.amount); 
          rows.push(row);
        }
