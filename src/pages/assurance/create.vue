        ...
        <div class="card">
          <div class="card-body">
            <h3 class="card-title text-white rounded p-3 mb-4 text-center"
              ...
              Ajouter de pack à l'assurance <strong style="text-transform: uppercase;">{{ insurance.name }}</strong>
            </h3>
            <form @submit.prevent="submitForm" class="forms-sample row">
              <div class="col-md-12">
                <!-- <div class="row">
                  <div class="form-group form-controls col-md-5">
...
export default {
  ...
  mounted() {
    ...
    insuranceService.getInsurance(this.uuid).then((res) => {
      ...
      this.selectedAssurance = this.insurance.uuid;
    });
  },
  methods: {
    addNewRow() {
