                ...
                <div class="col-md-5 vertical-line">
                  ...
                  <div class="col-md-12">
                    <div class="d-flex flex-column justify-content-center align-items-start"> 
                      ...
                      <p style="margin-top: -10px;">{{ product.conditioning_unit }}</p>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="d-flex flex-column justify-content-center align-items-start"> 
                      <p style="font-weight: bold;">Unité de vente:</p> 
                      <p style="margin-top: -10px;">{{ product.sales_unit }}</p>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="d-flex flex-column justify-content-center align-items-start"> 
                      <p style="font-weight: bold;">Fournisseur:</p> 
                      <p style="margin-top: -10px;">{{ product.supplier.name }}</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-7">
                  ...
                  <div class="col-md-12">
                    <div class="d-flex flex-column justify-content-center align-items-start"> 
                      ...
                      <p style="margin-top: -10px;">{{ product.administration_channel }}</p>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="d-flex flex-column justify-content-center align-items-start"> 
                  ...
                  <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center align-items-start"> 
                      <p style="font-weight: bold;">Marge (%):</p> 
                      <p style="margin-top: -10px;">{{ product.margin }}</p>
                    </div>
                  </div>
                </div> 
              </div>    
