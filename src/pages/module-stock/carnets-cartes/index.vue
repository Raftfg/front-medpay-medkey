  ...
  <section class="tables">
    <div class="row">
      <div class="col-lg-12 grid-margin">
        <h3 class="bg-success card-title text-white rounded p-2 mb-2 text-center" style="background-color: #0b5d3f; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); ">Liste des carnets et cartes</h3>
        <div class="card">
          <div class="card-body">
            <div class="d-flex flew-row justify-content-between" id="fixingIssue" style="margin-bottom: 5px;">
              <router-link to="/carnets-cartes/create" class="">
                <button
                  type="submit"
                    ...
                    <td class="text-right" width="50px">
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        >
                          ...
                          <!-- <hr class="m-1" /> -->
                          <!-- <button
                            class="dropdown-itemf font-weight-bold"
                            style="color: black;"
                            href="#"
                          >
                            <i
...
export default {
  ...
  methods: {
    detailsProduct(uuid)
    {
      this.$router.push("/carnets-cartes/" + uuid + "/details");
    },
    update(uuid) {
        this.$router.push("/carnets-cartes/update/" + uuid);
    },
  },
};
</script>
