<template>
  <section class="container-scroller">
    ...
    <!-- <div class="modal fade" id="updatePackPatientModal">
...
export default {
  ...
  methods: {
    ...
    //     patients_id: this.patients_id, // Utilisez this.patients_id au lieu de patients_id
    //     packpatients: this.packpatients,
    //   };
    //   console.log('dfsdsd');
    //   console.log(patients_id);
    //   console.log('Patients ID:', this.packpatient.patients_id); // Ajoutez cette ligne
