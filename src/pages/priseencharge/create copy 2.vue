              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label :for="'selectAssurance'">Assurance<span style="color: red">*</span></label>
                    <select @change="onInsuranceSelect(insuranceSelected)" v-model="insuranceSelected"
                      ...
                      <small v-if="errors && errors.insuranceSelected" class="text-danger">{{ errors.insuranceSelected[0]
                      }}</small>
                    </select>
                  </div>
                  <div class="form-group col-md-6">
                    <label :for="'selectPack'">Pack<span style="color: red">*</span></label>
                ...
                <div class="d-flex flex-column mb-2" id="supplyProductList">
                  <div class="form-group row customize-row">
                    ...
                    <div class="col-md-4">
                      <label class="form-label text-white p-2"
                  ...
                  <div v-if="errors && (errors.message || errors.pack_id || errors.insuranceSelected || errors.dateError)"
                    ...
                    <ul>
                      ...
                      <div v-if="errors.insuranceSelected" class="text-danger mt-3">{{ errors.insuranceSelected[0] }}
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      //   patients_id: this.packpatient.patients_id,
      //   pack_id: this.packpatient.pack_id,
      //   packpatient: this.packpatients,


      // });
      // Réinitialiser l'erreur de l'assurance
