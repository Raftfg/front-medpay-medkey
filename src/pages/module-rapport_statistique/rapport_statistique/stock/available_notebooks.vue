  ...
  <section class="tables">
    <div class="row">
      <div class="col-lg-12 grid-margin">
        <h3 class="bg-success card-title text-white rounded p-2 mb-2 text-center" style="background-color: #0b5d3f; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); ">Liste des carnets disponibles en stock</h3>
        <div class="card">
          <div class="card-body">
            <div class="table-responsive">
              ...
              >
                ...
                <tbody>
                  <tr v-for="(notebook, index) in notebooks" :key="notebook.uuid">
                    <td>{{ index + 1 }}</td>
                    <td>{{ notebook.product.code }}</td>
                    <td>{{ notebook.lot_number }}</td>
                    ...
                    <td class="text-right" width="50px">
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        >
                          <button
                            @click="detailsNotebooks(notebook.uuid)" class="dropdown-item font-weight-bold"
                            style="color: black;">
...
export default {
  ...
  methods: {
    detailsNotebooks(uuid)
    {
      this.$router.push("/carnets/disponible/" + uuid + "/details");
    },
  },
};
</script>
