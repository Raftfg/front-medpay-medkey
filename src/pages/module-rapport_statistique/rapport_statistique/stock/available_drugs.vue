  ...
  <section class="tables">
    <div class="row">
      <div class="col-lg-12 grid-margin">
        <h3 class="bg-success card-title text-white rounded p-2 mb-2 text-center" style="background-color: #0b5d3f; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); ">Liste des médicaments disponibles en stock</h3>
        <div class="card">
          <div class="card-body">
...
export default {
  ...
  methods: {
    detailsDrug(uuid)
    {
      this.$router.push("/medicaments/disponible/" + uuid + "/details");
    },
  },
};
</script>
