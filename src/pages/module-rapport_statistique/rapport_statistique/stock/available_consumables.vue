  ...
  <section class="tables">
    <div class="row">
      <div class="col-lg-12 grid-margin">
        <h3 class="bg-success card-title text-white rounded p-2 mb-2 text-center" style="background-color: #0b5d3f; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); ">Liste des consommables disponibles en stock</h3>
        <div class="card">
          <div class="card-body">
                  ...
                  <tr v-for="(consumable, index) in consumables" :key="consumable.uuid">
                    ...
                    <td class="text-right" width="50px">
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        >
                          <button
                            @click="detailsConsumable(consumable.uuid)" class="dropdown-item font-weight-bold"
                            style="color: black;">
...
export default {
  name: "list-available-consumables",
  ...
  methods: {
    detailsConsumable(uuid)
    {
      this.$router.push("/consommables/disponible/" + uuid + "/details");
    },
  },
};
</script>
