  ...
  <section class="tables">
    <div class="row">
      <div class="col-lg-12 grid-margin">
        <h3 class="bg-success card-title text-white rounded p-2 mb-2 text-center" style="background-color: #0b5d3f; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); ">Liste des médicaments périmés</h3>
        <div class="card">
          <div class="card-body">
                  ...
                  <tr v-for="(drug, index) in drugs" :key="drug.uuid">
                    ...
                    <td class="text-right" width="50px">
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        >
                          <button
                            @click="detailsDrug(drug.uuid)" class="dropdown-item font-weight-bold"
                            style="color: black;">
...
export default {
  ...
  mounted() {
    ...
    .then((res) => {
      ...
      this.drugs = res.data.expired_drugs;
      this.$nextTick(() => {
  ...
  methods: {
    detailsDrug(uuid)
    {
      this.$router.push("/medicaments/perimes/" + uuid + "/details");
    },
  },
};
</script>
