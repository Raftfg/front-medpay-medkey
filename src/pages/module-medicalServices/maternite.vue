  ...
  <section class="container-scroller">
   <div class="row">
    <div class="col-lg-12 grid-margin">
      ...
      "
      >
       <b>Maternité</b> : Liste des patientes en traitement
    </h3>
    <div class="card" >
      <div class="card-body" >
        <div class="input-group input-group-sm mb-3 w-100">
            ...
            <input v-on:keyup="page = 1; fetchLastMovement()" type="text" v-model="q" class="form-control rounded-pill py-3" placeholder="Rechercher une patiente ..."
            aria-label="">
