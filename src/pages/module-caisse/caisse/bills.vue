    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <h4
              class="text-white rounded p-3 text-center"
              style="background-color: #0b5d3f; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1)"
            >
              Liste des factures
              <span v-if="this.cashRegisterCashierCurrent.designation">
                - {{ this.cashRegisterCashierCurrent.designation }}</span
              >
            </h4>
            ...
            <form class="forms-sample mt-3 mt-4">
              <div class="row">
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                  ...
                  <select
                    class="form-control"
                    v-model="statutFacture"
                    name="statut"
                    @change="getAllFactures"
                  >
                ...
                <tbody>
                  <tr v-for="(facture, index) in factures" :key="facture.id">
                    ...
                    <td>
                      ...
                      <span v-else-if="facture.mode_payements_id == 2"
                    ...
                    <td style="text-align: right">
                      {{
                        facture.type == "P"
                          ? formatNumberDecimal(parseFloat(facture.montant_total))
                          : formatNumber(parseInt(facture.montant_total))
                      }}
                    </td>
                    ...
                    <td style="text-align: right">
                      {{
                        facture.type == "P"
                          ? formatNumberDecimal(parseFloat(facture.montant_assurance))
                    ...
                    <td style="text-align: right">
                      {{
                        facture.type == "P"
                          ? formatNumberDecimal(parseFloat(facture.montant_paye))
                    ...
                    <td class="" width="50px">
                      <div class="btn-group btn-group-sm" role="group">
                        ...
                        >
                          ...
                          <button
                            @click="generateAndOpenPDF(facture)"
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(factureDetail, index) in factureDetails" :key="index">
                      <td>
                        ...
                        <span v-else-if="factureDetail.mode_payements_id == 2"
                          >MOBILE MONEY</span
                        >
                        <span v-else-if="factureDetail.mode_payements_id == 3"
                          >MOOV MONEY</span
                        >
                        <span v-else-if="factureDetail.mode_payements_id == 4"
                          >CELTIS</span
                        >
                        <span v-else-if="factureDetail.mode_payements_id == 5"
                          >CARTE BANCAIRE</span
                        >
                        <span v-else-if="factureDetail.mode_payements_id == 6"
                          >CARTE DE CRÉDIT</span
                        >
                        <span v-else-if="factureDetail.mode_payements_id == 7"
                          >PAIEMENT TRESORPAY</span
                        >
                        <span v-else-if="factureDetail.mode_payements_id == 8"
                          >PAIEMENT A CREDIT</span
                        >
                      </td>
                      <td>
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td>
                        <strong
                          >{{ formatNumber(this.assurancePourcentage) }} FCFA</strong
                        >
                      </td>
                    </tr>
        ...
        .then((res) => {
          ...
          if (this.facturesReference.length > 0) {
            ...
            const partieVersanteText = [
              "PARTIE VERSANTE :",
              this.facturesReference[0].firstname +
                " " +
                this.facturesReference[0].lastname,
              "IPP : " + this.facturesReference[0].ipp,
              "IEP : " + this.facturesReference[0].iep,
              this.facturesReference[0].emergency_contac +
                (this.facturesReference[0].phone
                  ? " / " + this.facturesReference[0].phone
                  : ""),
            ];
            ...
            if (partieVersanteText && Array.isArray(partieVersanteText)) {
              ...
              for (let i = 0; i < partieVersanteText.length; i++) {
                ...
                if (i === 2 || i === 3) {
                  ...
                  pdfDoc.text(keywordText, partieVersanteX, partieVersanteY, {
                    lineHeight,
                  });
            ...
            if (autresInformationsText && Array.isArray(autresInformationsText)) {
              ...
              for (let i = 0; i < autresInformationsText.length; i++) {
                ...
                pdfDoc.text(line, textX, autresInformationsY, {
                  lineHeight,
                  align: "left",
                });
            ...
            if (this.facturesReference && this.facturesReference.length > 0) {
              ...
              for (var i = 0; i < this.facturesReference.length; i++) {
                ...
                var row = [
                  ...
                  this.formatNumber(parseInt(this.facturesReference[i].prix)),
                  this.formatNumber(parseInt(amount)),
                ];

                total += amount;
                rows.push(row);
              }
              const montantPriseEnCharge =
                total * (this.facturesReference[0]["percentageassurance"] || 0);
              // const montantTotalVerse =
              //   this.facturesReference[0]["partial_amount"] !== null
              //     ? this.facturesReference[0]["partial_amount"]
              //     : total - montantPriseEnCharge;

              let montantTotalVerse;
              if (this.facturesReference.length > 0) {
                const modePayementsId = this.facturesReference[0].mode_payements_id;
              ...
              rows.push([
...

                {
                  content:
                    facture.type === "A"
                      ? this.formatNumber(parseInt(total)) + " FCFA"
                      : this.formatNumberDecimal(total) + " FCFA",
                  colSpan: 1,
                  styles: { fontStyle: "bold", halign: "right", textColor: [0, 0, 0] },
                },
              ]);

              rows.push([
                {
                  content: "Montant de la prise en charge (-)",
                  colSpan: 4,
                  styles: { fontStyle: "bold", halign: "left", textColor: [0, 0, 0] },
                },

                {
                  content:
                    facture.type === "A"
                      ? this.formatNumber(parseInt(montantPriseEnCharge)) + " FCFA"
                      : this.formatNumberDecimal(montantPriseEnCharge) + " FCFA",
                  colSpan: 1,
                  styles: { fontStyle: "bold", halign: "right", textColor: [0, 0, 0] },
                },
              ]);
              rows.push([
...

                {
                  content:
                    facture.type == "A"
                      ? this.formatNumber(parseInt(montantTotalVerse)) + " FCFA"
                      : this.formatNumberDecimal(montantTotalVerse) + " FCFA",
                  colSpan: 1,
                  styles: {
                    fontStyle: "bold",
                    halign: "right",
              ...
              const phraseAvecMontant =
                "Arrêté la présente facture à la somme de: " +
                (facture.type === "A"
                  ? this.convertNumberToLetter(montantTotalVerse)
                  : this.convertToWords(montantTotalVerse)) +
                " FCFA";
              ...
              const maxTextWidth =
                pdfDoc.internal.pageSize.getWidth() - marginLeft - qrCodeSize - 20; // Ajustez l'espace disponible
              ...
              for (let i = 0; i < textLines.length; i++) {
                ...
                const lineHeight = pdfDoc.getTextDimensions(line, {
                  maxWidth: maxTextWidth,
                }).h;

                // Ajoutez la ligne de texte justifié en gras
                pdfDoc.text(line, marginLeft, currentY, {
                  maxWidth: maxTextWidth,
                  align: "justify",
                  fontStyle: "bold",
                });
              ...
              const positionYSignataires = currentY + 10; // Ajustez la valeur selon vos besoins
              ...
              for (let i = 0; i < numberOfSignataires; i++) {
                ...
                pdfDoc.text(
                  positionX,
                  positionYSignataires + 25,
                  signataire.name + " " + signataire.prenom,
                  {
                    align:
                      numberOfSignataires === 1
                        ? "right"
    ...
    getAllFactures() {
      ...
      factureService
        ...
        .then((res) => {
          ...
          this.factures = res.data.data.filter(
            (facture) => facture.cash_registers_id == cashRegisterId
          );
