    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4
              class="text-white rounded p-3 mb-5 text-center"
            ...
            <div class="row col-md-12 mt-n4">
              <div
                class="col-md-4"
                v-if="cashRegisterCashierCurrent.statut !== undefined"
              >
                <h5>
                  ...
                  <strong>
                    ...
                    (<span
                      :style="
                        cashRegisterCashierCurrent.statut == 1
                          ? 'color: red;'
                          : 'color: green;'
                      "
                    >
              ...
              <div
                class="col-md-4"
                v-if="cashsHistoricalCurrent && cashsHistoricalCurrent.created_at"
              >
                <h5>
              ...
              <div
                class="col-md-4"
                v-if="cashsHistoricalCurrent && cashsHistoricalCurrent.statut == 1"
              >
                <h5>
              ...
              <div
                class="col-md-4"
                v-if="cashsHistoricalCurrent && cashsHistoricalCurrent.statut == 0"
              >
                <h5>
            ...
            <div class="col-md-12 col-lg-12 mt-3">
              <div class="row">
                ...
                <div class="search-bar col-md-6 col-lg-6">
                  <input
                    @input="getListAndSearchMovments"
                    type="text"
                    v-model="searchTerm"
            ...
            <div v-if="displayedMovments.length > 0" class="table-responsive mt-4 tables">
              <table id="order-listing" ref="myTableMovment" class="table table-bordered">
                ...
                <tr
                  class="row-hover"
                  v-for="(movment, index) in displayedMovments"
                  :key="movment.id"
                  @click="selectRow(index, movment.id)"
            ...
            <div
              v-if="indexSpinner"
              class="spinner-border spinner-border-sm text-secocndary"
            ...
            <div
              v-if="
                filteredMedicalActDetailsA.length > 0 &&
                this.selectedRow != -1 &&
            ...
            >
              <ul class="nav nav-tabs d-flex justify-content-between" role="tablist">
                <li>
                  <button
                    class="nav-link active font-weight-bold custom-tab"
                    data-bs-toggle="tab"
                    href="#tab1"
                  >
                ...
                <li class="d-flex">
                  <select
                    ...
                    style="width: 300px; background-color: #e0faf3"
                    id="exampleFormControlSelect1"
                    v-model="selectedOptionMode"
                    @change="fetchModePayementDetails"
                  >
                    <option value="" style="margin-top: 10px" disabled>
                      MODES DE PAIEMENT
                    </option>
                ...
                <div class="table-responsive tab-pane fade show active" id="tab1">
                  ...
                  <div>
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          v-for="(item, index) in filteredMedicalActDetailsA"
                          :key="index"
                        >
                          <td>{{ index + 1 }}</td>
              ...
              <div class="d-flex justify-content-between flex-row">
                <div
                  class="mt-0"
                  v-if="selectedOptionMode >= 1 && selectedOptionMode <= 7"
                >
                  ...
                  <p v-if="showMontantError" class="error-message mt-n3 mx-auto">
                ...
                <div v-if="selectedOptionMode == 2" class="mt-n1">
                  ...
                  <div class="d-flex justify-content-end mt-0">
                    <button
                      ...
                      style="white-space: nowrap; overflow: hidden"
                    >
                      <span class="text-center ml-1" style="font-size: 90%"
              ...
              <div v-if="selectedOptionMode == 8" class="mt-n1 text-right">
                <div class="text-right mt-0">
                  <button
                    @click="validerPayement"
                    type="button"
                    class="btn-medpay-green btn btn-success btn-sm mt-n1"
                    style="white-space: nowrap; overflow: hidden"
                  >
                ...
                <div class="table-responsive tab-pane fade show active" id="tab1">
                  ...
                  <div>
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          v-for="(item, index) in filteredMedicalActDetailsP"
                          :key="index"
                        >
                          <td>{{ index + 1 }}</td>
                          <td style="text-align: left !important">{{ item.code }}</td>
                        ...
                        <tr style="background-color: #d6dbd6 !important">
                          ...
                          <td style="font-weight: bold !important; text-align: right">
                            {{
                              formatNumberDecimal(
                                totalAmountActesP() - montantPrisenchargePourcentageP
                              )
                            }}
                            FCFA
                          </td>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button
                      ...
                      type="button"
                      class="btn btn-success btn-connexion-green mx-auto mt-n2"
                      @click="ShowFacture"
                    >
              ...
              >
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div
                      class="modal-body d-flex justify-content-between col-12 flex-row"
                    >
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button
                        type="button"
                        class="btn btn-success mx-auto mt-n2"
                        @click="ShowFacture"
                      >
  ...
  methods: {
        ...
        factureService
          ...
          .then((response) => {
            ...
            if (
              ...
              this.medicalActDetailsFactureP.length > 0
            ) {
              ...
              this.montantPrisenchargePourcentageP =
                (this.prisenchargePourcentageP * this.totalAmountActesP()) / 100;
            }
    ...
    validerPayement() {
      ...
      if (this.isChecked && parseFloat(this.montantPartiel) >= totalAmountActes) {
        ...
        this.showMontantError = false;
        this.$toast.error(
          "Le montant saisie doit être inférieur au montant total à payer sur la facture.",
          {
            position: "top-right",
            timeout: 3000,
            style: {
    ...
    payementFacture() {
      ...
      const partial_amount = this.isChecked ? this.montantPartiel : 0.0;
      ...
      factureService
        .payementFacture(
          this.cashRegisterCashierCurrent.id,
          referenceToUse,
          this.selectedOptionMode,
          partial_amount
        ) // Utilisez la clé "factures"
        .then((res) => {
          this.selectedRow = -1;
